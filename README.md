# About Emberpeak
Eberpeak is a turn-based pet training game that is inspired by Pokémon. It is currently in early development and is not finished! Users can create a pet and there is a UI that users can interact with, but UI functions and load/save codes are still a work in progress. User input is also very flexible and the user does not have to just enter "1" or "2" to access certain options, they can also type in "New game", "Load game", etc.

# How to Play Emberpeak
- Emberpeak is an interactive text game that is similar to Pokémon. You play as a newly graduated trainer in the lands of Emberpeak. Your goal is to explore, complete challenges, and train your pet to be the strongest pet in the lands!
...
- The player will start with a pet that has attack and defensive stats. These stats can be trained and leveled up in the Training Grounds.
...
# Latest Updates to Emberpeak
- N/A

# Updates to come to Emberpeak
- Fully functioning UI menu.
- Gameplay.
- Input validation.
- Save/Load codes.
